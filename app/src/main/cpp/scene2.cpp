...
//    model.modelMatrix=glm::translate(0.0f,0.0f,1.0f)*glm::scale(0.03f,0.03f,0.03f);
//    model.modelMatrix = glm::translate( model.modelMatrix , glm::vec3(0.0f,0.0f,2.0f));
//    model.modelMatrix = glm::scale( model.modelMatrix , glm::vec3(0.3f,0.3f,0.3f));
//    model.modelMatrix = glm::scale( model.modelMatrix , glm::vec3(0.03f,0.03f,0.03f));
